import { FullProblemDefinationParser } from "@shreekanthlakka/common";
import fs from "fs";
import path, { dirname } from "path";
import { fileURLToPath } from "url";

const generateFullBoilerPlateCode = (title, parsedTestCases) => {
    ...
    const parse = new FullProblemDefinationParser(
        title,
        title,
        inputs,
        outputObj
...
export { generateFullBoilerPlateCode };
